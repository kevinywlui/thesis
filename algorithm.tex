...
\begin{algorithm}{Decomposing and Verifying Abelian Subvarieties}
    ...
    into simples $X_i=(V_i, J)$ of $B$, otherwise, this algorithm will return
...
In this section, we will describe how we are explicitly representing morphisms
between modular abelian varieties

...
\subsection{Galois Cohomology Bounds}%
\label{sub:galois_cohomology_bounds}
...
\subsubsection{Approach to computing $J(\QQ)_\tor$}%
\label{ssub:approach_to_computing_j_qq__tor_}

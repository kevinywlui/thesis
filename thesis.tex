...
will assume reader has taken a graduate level algebra sequence and have some
exposure to complex abelian varieties and modular forms. For learning about
complex abelian varieties, I recommend the article of Rosen
...
Chapter~\ref{chap:algorithms} has been largely taken from a forthcoming paper
by Hao Chen, myself, and William Stein. For the most part, the algorithms were
created and implemented into \sage and \magma and William Stein.

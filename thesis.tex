...
\dedication{\begin{center}to mom and dad\end{center}}
...
I've have written this thesis with accessibility in mind. In particular, my
goal was to write a thesis assessable to myself as a second graduate student. I
will assume reader has taken a graduate level algebra sequence and have had
some exposure to complex abelian varieties and modular forms. For learning
about complex abelian varieties, I recommend the article of Rosen
...
William Stein. This chapter is included in this thesis so we are not relying on
...
We first define degeneracy maps on modular curves. Recall that the non-cuspidal
...
$d_{L,t}$ extends uniquely to a map (which we give the same name)
$d_{L,t}:X_0(N)\to X_0(L)$.

By Pic and Alb functoriality, this induces the maps $d_{L,t} ^*:J_0(L)\to
J_0(N)$, $d_{L, t}_*:J_0(N)\to J_0(L)$, respectively. Here's a more concrete
description.

...
II]{stevens:param} which states that within an isogeny class, the $J_1(N)$-optimal
curve is the curve of minimal Faltings height. This conjecture has been proven
in the prime level case by Stein and Watkins~\cite[\S 3]{stein-watkins:ns}.
% TODO: include Vatsal
...
divisors of $M$ in increasing order. For every divisor $t$ of $M$, there exists
a degeneracy map between modular curves given on the non-cuspidal points by
\begin{align*}
